...
Project done during **Full Stack Software Engineering studies** at **Alx Software Engineering**. It aims to learn how to open, read, write and append files from a script in **Python**.
